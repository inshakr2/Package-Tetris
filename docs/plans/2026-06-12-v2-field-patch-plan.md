...
- 현재 작업 `.xlsx` import의 박스명은 앞뒤 공백과 대소문자를 보정해 저장 박스와 연결한다. 단, 글자가 다른 박스명은 새 저장 박스로 만들지 않고 오류 행으로 안내한다.
...
- 현재 작업 엑셀 import의 박스명 보정 범위는 앞뒤 공백/대소문자까지이며, 글자가 다른 박스명은 오류 행으로 안내한다고 문서와 테스트에 남긴다.
